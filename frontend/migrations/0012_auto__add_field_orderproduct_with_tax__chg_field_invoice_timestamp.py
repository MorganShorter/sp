...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderProduct.with_tax'
        db.add_column(u'frontend_orderproduct', 'with_tax',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Invoice.timestamp'
        db.alter_column(u'frontend_invoice', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'OrderProduct.with_tax'
        db.delete_column(u'frontend_orderproduct', 'with_tax')


        # Changing field 'Invoice.timestamp'
        db.alter_column(u'frontend_invoice', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
