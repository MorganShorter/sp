...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.abn'
        db.add_column(u'frontend_company', 'abn',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.abn'
        db.delete_column(u'frontend_company', 'abn')
    ...
    models = {
        ...
        u'frontend.company': {
            ...
            'abn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'payments': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
