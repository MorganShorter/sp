...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SPUser'
        db.create_table(u'frontend_spuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('last_login', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=255)),
            ('font_size', self.gf('django.db.models.fields.IntegerField')(default=12)),
            ('font_weight', self.gf('django.db.models.fields.CharField')(default='normal', max_length=16)),
            ('bg_color', self.gf('colorfield.fields.ColorField')(default='#ffffff', max_length=10)),
            ('label_bg_color', self.gf('colorfield.fields.ColorField')(max_length=10)),
            ('font_color', self.gf('colorfield.fields.ColorField')(max_length=10)),
            ('jodabrian_visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'frontend', ['SPUser'])

        orm['frontend.OrderStatus'].objects.filter(user__isnull=False).delete()
        orm['frontend.StockAdjust'].objects.filter(user__isnull=False).delete()


        # Changing field 'StockAdjust.user'
        db.alter_column(u'frontend_stockadjust', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['frontend.SPUser']))

        # Changing field 'OrderStatus.user'
        db.alter_column(u'frontend_orderstatus', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['frontend.SPUser'], null=True))

    def backwards(self, orm):
        # Deleting model 'SPUser'
        db.delete_table(u'frontend_spuser')


        # Changing field 'StockAdjust.user'
        db.alter_column(u'frontend_stockadjust', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'OrderStatus.user'
        db.alter_column(u'frontend_orderstatus', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'frontend.spuser': {
            ...
            'bg_color': ('colorfield.fields.ColorField', [], {'default': "'#ffffff'", 'max_length': '10'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '255'}),
            'font_color': ('colorfield.fields.ColorField', [], {'max_length': '10'}),
            'font_size': ('django.db.models.fields.IntegerField', [], {'default': '12'}),
            'font_weight': ('django.db.models.fields.CharField', [], {'default': "'normal'", 'max_length': '16'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jodabrian_visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'label_bg_color': ('colorfield.fields.ColorField', [], {'max_length': '10'}),
