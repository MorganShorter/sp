...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderProduct.slug'
        db.delete_column(u'frontend_orderproduct', 'slug')

        # Deleting field 'Order.slug'
        db.delete_column(u'frontend_order', 'slug')

        # Deleting field 'RoyaltyImg.slug'
        db.delete_column(u'frontend_royaltyimg', 'slug')

        # Deleting field 'Size.slug'
        db.delete_column(u'frontend_size', 'slug')

        # Deleting field 'CustomerContact.slug'
        db.delete_column(u'frontend_customercontact', 'slug')

        # Deleting field 'OrderStatus.slug'
        db.delete_column(u'frontend_orderstatus', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OrderProduct.slug'
        raise RuntimeError("Cannot reverse this migration. 'OrderProduct.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OrderProduct.slug'
        db.add_column(u'frontend_orderproduct', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Order.slug'
        raise RuntimeError("Cannot reverse this migration. 'Order.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Order.slug'
        db.add_column(u'frontend_order', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'RoyaltyImg.slug'
        raise RuntimeError("Cannot reverse this migration. 'RoyaltyImg.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RoyaltyImg.slug'
        db.add_column(u'frontend_royaltyimg', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Size.slug'
        raise RuntimeError("Cannot reverse this migration. 'Size.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Size.slug'
        db.add_column(u'frontend_size', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)

        # Adding field 'CustomerContact.slug'
        db.add_column(u'frontend_customercontact', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'OrderStatus.slug'
        raise RuntimeError("Cannot reverse this migration. 'OrderStatus.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OrderStatus.slug'
        db.add_column(u'frontend_orderstatus', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)
