...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderProduct.discount_price'
        db.delete_column(u'frontend_orderproduct', 'discount_price')

        # Deleting field 'OrderProduct.unit_tax'
        db.delete_column(u'frontend_orderproduct', 'unit_tax')

        # Deleting field 'OrderProduct.royalty_amount'
        db.delete_column(u'frontend_orderproduct', 'royalty_amount')

        # Deleting field 'Order.sp_cost'
        db.delete_column(u'frontend_order', 'sp_cost')

        # Deleting field 'Order.sub_total'
        db.delete_column(u'frontend_order', 'sub_total')

        # Deleting field 'Order.tax'
        db.delete_column(u'frontend_order', 'tax')

        # Deleting field 'Order.discount'
        db.delete_column(u'frontend_order', 'discount')

        # Adding field 'Order.total_price'
        db.add_column(u'frontend_order', 'total_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OrderProduct.discount_price'
        db.add_column(u'frontend_orderproduct', 'discount_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'OrderProduct.unit_tax'
        db.add_column(u'frontend_orderproduct', 'unit_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'OrderProduct.royalty_amount'
        db.add_column(u'frontend_orderproduct', 'royalty_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.sp_cost'
        db.add_column(u'frontend_order', 'sp_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.sub_total'
        db.add_column(u'frontend_order', 'sub_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.tax'
        db.add_column(u'frontend_order', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.discount'
        db.add_column(u'frontend_order', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Order.total_price'
        db.delete_column(u'frontend_order', 'total_price')
