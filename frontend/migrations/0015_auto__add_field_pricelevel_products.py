...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PriceLevel.products'
        db.add_column(u'frontend_pricelevel', 'products',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='price_levels', null=True, to=orm['frontend.Product']),
                      keep_default=False)

        # Removing M2M table for field products on 'PriceLevel'
        db.delete_table(db.shorten_name(u'frontend_pricelevel_products'))


    def backwards(self, orm):
        # Deleting field 'PriceLevel.products'
        db.delete_column(u'frontend_pricelevel', 'products_id')

        # Adding M2M table for field products on 'PriceLevel'
        m2m_table_name = db.shorten_name(u'frontend_pricelevel_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pricelevel', models.ForeignKey(orm[u'frontend.pricelevel'], null=False)),
            ('product', models.ForeignKey(orm[u'frontend.product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pricelevel_id', 'product_id'])
    ...
    models = {
        ...
        u'frontend.pricelevel': {
            ...
            'products': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'price_levels'", 'null': 'True', 'to': u"orm['frontend.Product']"})
        },
