...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'frontend_pricelevelgroup')

        # Deleting model 'RoyaltyImg'
        db.delete_table(u'frontend_royaltyimg')

        # Adding model 'RoyaltyGroup'
        db.create_table(u'frontend_royaltygroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('royalty', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal(u'frontend', ['RoyaltyGroup'])

        # Deleting field 'Product.royalty_img'
        db.delete_column(u'frontend_product', 'royalty_img_id')

        # Deleting field 'Product.royalty'
        db.delete_column(u'frontend_product', 'royalty')

        # Adding field 'Product.royalty_group'
        db.add_column(u'frontend_product', 'royalty_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['frontend.RoyaltyGroup'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'Product.manual_royalty'
        db.add_column(u'frontend_product', 'manual_royalty',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'PriceLevel.block_only'
        db.delete_column(u'frontend_pricelevel', 'block_only')

        # Deleting field 'PriceLevel.cost_per_block'
        db.delete_column(u'frontend_pricelevel', 'cost_per_block')


    def backwards(self, orm):
        # Adding model 'PriceLevelGroup'
        db.create_table(u'frontend_pricelevelgroup', (
            ('royalty', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'frontend', ['PriceLevelGroup'])

        # Adding model 'RoyaltyImg'
        db.create_table(u'frontend_royaltyimg', (
        ...
        db.send_create_signal(u'frontend', ['RoyaltyImg'])

        # Deleting model 'RoyaltyGroup'
        db.delete_table(u'frontend_royaltygroup')

        # Adding field 'Product.royalty_img'
        db.add_column(u'frontend_product', 'royalty_img',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.PROTECT, to=orm['frontend.RoyaltyImg']),
                      keep_default=False)
        ...
        # Deleting field 'Product.royalty_group'
        db.delete_column(u'frontend_product', 'royalty_group_id')

        # Deleting field 'Product.manual_royalty'
        db.delete_column(u'frontend_product', 'manual_royalty')

        # Adding field 'PriceLevel.block_only'
        db.add_column(u'frontend_pricelevel', 'block_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PriceLevel.cost_per_block'
        db.add_column(u'frontend_pricelevel', 'cost_per_block',
    ...
    models = {
        ...
        u'frontend.product': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_read': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
