...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.last_read'
        db.add_column(u'frontend_customer', 'last_read',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.last_read'
        db.delete_column(u'frontend_customer', 'last_read')
    ...
    models = {
        ...
        u'frontend.spuser': {
            ...
            'font_color': ('colorfield.fields.ColorField', [], {'default': "'#2B2B2B'", 'max_length': '10'}),
            ...
            'label_bg_color': ('colorfield.fields.ColorField', [], {'default': "'#EEEEEE'", 'max_length': '10'}),
