...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SPUser.is_active'
        db.add_column(u'frontend_spuser', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SPUser.is_admin'
        db.add_column(u'frontend_spuser', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SPUser.is_active'
        db.delete_column(u'frontend_spuser', 'is_active')

        # Deleting field 'SPUser.is_admin'
        db.delete_column(u'frontend_spuser', 'is_admin')
