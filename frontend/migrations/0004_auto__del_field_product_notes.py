...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field notes on 'Order'
        m2m_table_name = db.shorten_name(u'frontend_order_notes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'frontend.order'], null=False)),
            ('note', models.ForeignKey(orm[u'frontend.note'], null=False))
        ))
        db.create_unique(m2m_table_name, ['order_id', 'note_id'])

        # Adding M2M table for field notes on 'Customer'
        m2m_table_name = db.shorten_name(u'frontend_customer_notes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customer', models.ForeignKey(orm[u'frontend.customer'], null=False)),
            ('note', models.ForeignKey(orm[u'frontend.note'], null=False))
        ))
        db.create_unique(m2m_table_name, ['customer_id', 'note_id'])

        # Deleting field 'Product.notes'
        db.delete_column(u'frontend_product', 'notes')

        # Adding M2M table for field notes on 'Product'
        m2m_table_name = db.shorten_name(u'frontend_product_notes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'frontend.product'], null=False)),
            ('note', models.ForeignKey(orm[u'frontend.note'], null=False))
        ))
        db.create_unique(m2m_table_name, ['product_id', 'note_id'])


    def backwards(self, orm):
        # Removing M2M table for field notes on 'Order'
        db.delete_table(db.shorten_name(u'frontend_order_notes'))

        # Removing M2M table for field notes on 'Customer'
        db.delete_table(db.shorten_name(u'frontend_customer_notes'))

        # Adding field 'Product.notes'
        db.add_column(u'frontend_product', 'notes',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Removing M2M table for field notes on 'Product'
        db.delete_table(db.shorten_name(u'frontend_product_notes'))
    ...
    models = {
        ...
        u'frontend.customer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'notes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'customer_notes'", 'symmetrical': 'False', 'to': u"orm['frontend.Note']"}),
        ...
        u'frontend.order': {
            ...
            'notes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'order_notes'", 'symmetrical': 'False', 'to': u"orm['frontend.Note']"}),
        ...
        u'frontend.product': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'notes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'product_notes'", 'symmetrical': 'False', 'to': u"orm['frontend.Note']"}),
