...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SPUser.font_size'
        db.alter_column(u'frontend_spuser', 'font_size', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SPUser.font_weight'
        db.alter_column(u'frontend_spuser', 'font_weight', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'SPUser.label_bg_color'
        db.alter_column(u'frontend_spuser', 'label_bg_color', self.gf('colorfield.fields.ColorField')(max_length=10, null=True))

        # Changing field 'SPUser.bg_color'
        db.alter_column(u'frontend_spuser', 'bg_color', self.gf('colorfield.fields.ColorField')(max_length=10, null=True))

        # Changing field 'SPUser.font_color'
        db.alter_column(u'frontend_spuser', 'font_color', self.gf('colorfield.fields.ColorField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'SPUser.font_size'
        db.alter_column(u'frontend_spuser', 'font_size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SPUser.font_weight'
        db.alter_column(u'frontend_spuser', 'font_weight', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'SPUser.label_bg_color'
        db.alter_column(u'frontend_spuser', 'label_bg_color', self.gf('colorfield.fields.ColorField')(max_length=10))

        # Changing field 'SPUser.bg_color'
        db.alter_column(u'frontend_spuser', 'bg_color', self.gf('colorfield.fields.ColorField')(max_length=10))

        # Changing field 'SPUser.font_color'
        db.alter_column(u'frontend_spuser', 'font_color', self.gf('colorfield.fields.ColorField')(max_length=10))
