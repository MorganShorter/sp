...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackOrder'
        db.create_table(u'frontend_backorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='back_orders', to=orm['frontend.Order'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='back_orders', to=orm['frontend.Product'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
            ('complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'frontend', ['BackOrder'])


    def backwards(self, orm):
        # Deleting model 'BackOrder'
        db.delete_table(u'frontend_backorder')
    ...
    models = {
        ...
        u'frontend.backorder': {
            'Meta': {'object_name': 'BackOrder'},
            'amount': ('django.db.models.fields.IntegerField', [], {}),
            'complete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'back_orders'", 'to': u"orm['frontend.Order']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'back_orders'", 'to': u"orm['frontend.Product']"})
        },
        u'frontend.catalog': {
