...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BackOrder.timestamp'
        db.add_column(u'frontend_backorder', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BackOrder.timestamp'
        db.delete_column(u'frontend_backorder', 'timestamp')
