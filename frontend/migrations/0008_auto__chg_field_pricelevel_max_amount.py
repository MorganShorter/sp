...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PriceLevel.max_amount'
        db.alter_column(u'frontend_pricelevel', 'max_amount', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PriceLevel.max_amount'
        raise RuntimeError("Cannot reverse this migration. 'PriceLevel.max_amount' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PriceLevel.max_amount'
        db.alter_column(u'frontend_pricelevel', 'max_amount', self.gf('django.db.models.fields.PositiveIntegerField')())
