...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderProduct.last_quantity'
        db.add_column(u'frontend_orderproduct', 'last_quantity',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderProduct.last_quantity'
        db.delete_column(u'frontend_orderproduct', 'last_quantity')
