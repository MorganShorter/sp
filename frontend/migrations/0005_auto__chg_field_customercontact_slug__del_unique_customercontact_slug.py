...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CustomerContact', fields ['slug']
        db.delete_unique(u'frontend_customercontact', ['slug'])


        # Changing field 'CustomerContact.slug'
        db.alter_column(u'frontend_customercontact', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'CustomerContact.slug'
        db.alter_column(u'frontend_customercontact', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=150, unique=True))
        # Adding unique constraint on 'CustomerContact', fields ['slug']
        db.create_unique(u'frontend_customercontact', ['slug'])
