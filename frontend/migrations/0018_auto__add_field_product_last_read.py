...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.last_read'
        db.add_column(u'frontend_product', 'last_read',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 6, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.last_read'
        db.delete_column(u'frontend_product', 'last_read')
