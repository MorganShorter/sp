...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PriceLevel.slug'
        db.delete_column(u'frontend_pricelevel', 'slug')

        # Deleting field 'PriceLevelGroup.slug'
        db.delete_column(u'frontend_pricelevelgroup', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PriceLevel.slug'
        raise RuntimeError("Cannot reverse this migration. 'PriceLevel.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PriceLevel.slug'
        db.add_column(u'frontend_pricelevel', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PriceLevelGroup.slug'
        raise RuntimeError("Cannot reverse this migration. 'PriceLevelGroup.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PriceLevelGroup.slug'
        db.add_column(u'frontend_pricelevelgroup', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'frontend.pricelevel': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_amount': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
