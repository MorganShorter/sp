...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PriceLevel.price_level_group'
        db.delete_column(u'frontend_pricelevel', 'price_level_group_id')

        # Adding field 'PriceLevelGroup.royalty'
        db.add_column(u'frontend_pricelevelgroup', 'royalty',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PriceLevel.price_level_group'
        db.add_column(u'frontend_pricelevel', 'price_level_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='price_levels', null=True, to=orm['frontend.PriceLevelGroup'], blank=True),
                      keep_default=False)

        # Deleting field 'PriceLevelGroup.royalty'
        db.delete_column(u'frontend_pricelevelgroup', 'royalty')
