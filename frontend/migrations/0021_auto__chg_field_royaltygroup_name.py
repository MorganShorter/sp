...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoyaltyGroup.name'
        db.alter_column(u'frontend_royaltygroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'RoyaltyGroup.name'
        db.alter_column(u'frontend_royaltygroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
