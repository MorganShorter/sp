...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'frontend_invoice', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Invoice.slug'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Invoice.slug'
        db.add_column(u'frontend_invoice', 'slug',
