...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'frontend_note')

        # Deleting field 'Invoice.number'
        db.delete_column(u'frontend_invoice', 'number')
