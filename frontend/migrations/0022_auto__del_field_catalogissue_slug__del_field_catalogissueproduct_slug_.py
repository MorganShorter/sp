...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CatalogIssue.slug'
        db.delete_column(u'frontend_catalogissue', 'slug')

        # Deleting field 'CatalogIssueProduct.slug'
        db.delete_column(u'frontend_catalogissueproduct', 'slug')

        # Deleting field 'OrderProduct.sp_price'
        db.delete_column(u'frontend_orderproduct', 'sp_price')

        # Deleting field 'Catalog.slug'
        db.delete_column(u'frontend_catalog', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CatalogIssue.slug'
        raise RuntimeError("Cannot reverse this migration. 'CatalogIssue.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CatalogIssue.slug'
        db.add_column(u'frontend_catalogissue', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CatalogIssueProduct.slug'
        raise RuntimeError("Cannot reverse this migration. 'CatalogIssueProduct.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CatalogIssueProduct.slug'
        db.add_column(u'frontend_catalogissueproduct', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)

        # Adding field 'OrderProduct.sp_price'
        db.add_column(u'frontend_orderproduct', 'sp_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Catalog.slug'
        raise RuntimeError("Cannot reverse this migration. 'Catalog.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Catalog.slug'
        db.add_column(u'frontend_catalog', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)
