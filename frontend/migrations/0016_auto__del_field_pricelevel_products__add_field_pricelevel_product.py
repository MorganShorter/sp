...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PriceLevel.product'
        db.add_column(u'frontend_pricelevel', 'product',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'frontend_pricelevel', 'products',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='price_levels', null=True, to=orm['frontend.Product'], blank=True),
                      keep_default=False)

        # Deleting field 'PriceLevel.product'
        db.delete_column(u'frontend_pricelevel', 'product_id')
