...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StockAdjust'
        db.create_table(u'frontend_stockadjust', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stock_adjust', to=orm['frontend.Product'])),
            ('current_amount', self.gf('django.db.models.fields.IntegerField')()),
            ('added_amount', self.gf('django.db.models.fields.IntegerField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('reason', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'frontend', ['StockAdjust'])


    def backwards(self, orm):
        # Deleting model 'StockAdjust'
        db.delete_table(u'frontend_stockadjust')
