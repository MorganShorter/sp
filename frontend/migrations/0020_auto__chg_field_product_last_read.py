...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.last_read'
        db.alter_column(u'frontend_product', 'last_read', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Product.last_read'
        raise RuntimeError("Cannot reverse this migration. 'Product.last_read' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Product.last_read'
        db.alter_column(u'frontend_product', 'last_read', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
