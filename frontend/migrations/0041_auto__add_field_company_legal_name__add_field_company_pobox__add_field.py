...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.legal_name'
        db.add_column(u'frontend_company', 'legal_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.pobox'
        db.add_column(u'frontend_company', 'pobox',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.address'
        db.add_column(u'frontend_company', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.default_invoice'
        db.add_column(u'frontend_company', 'default_invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_invoices', null=True, to=orm['frontend.Document']),
                      keep_default=False)

        # Adding field 'Company.default_packing_slip'
        db.add_column(u'frontend_company', 'default_packing_slip',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_packing_slip', null=True, to=orm['frontend.Document']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.legal_name'
        db.delete_column(u'frontend_company', 'legal_name')

        # Deleting field 'Company.pobox'
        db.delete_column(u'frontend_company', 'pobox')

        # Deleting field 'Company.address'
        db.delete_column(u'frontend_company', 'address')

        # Deleting field 'Company.default_invoice'
        db.delete_column(u'frontend_company', 'default_invoice_id')

        # Deleting field 'Company.default_packing_slip'
        db.delete_column(u'frontend_company', 'default_packing_slip_id')
    ...
    models = {
        ...
        u'frontend.company': {
            ...
            'default_invoice': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'default_invoices'", 'null': 'True', 'to': u"orm['frontend.Document']"}),
            'default_packing_slip': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'default_packing_slip'", 'null': 'True', 'to': u"orm['frontend.Document']"}),
            ...
            'pobox': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'frontend.document': {
            'Meta': {'ordering': "('-dt',)", 'object_name': 'Document'},
