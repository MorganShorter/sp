...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.royalty_img'
        db.alter_column(u'frontend_product', 'royalty_img_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['frontend.RoyaltyImg']))

        # Changing field 'Product.supplier'
        db.alter_column(u'frontend_product', 'supplier_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['frontend.Supplier']))

        # Changing field 'Product.medium'
        db.alter_column(u'frontend_product', 'medium_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['frontend.Medium']))

        # Changing field 'Product.size'
        db.alter_column(u'frontend_product', 'size_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['frontend.Size']))
        # Deleting field 'Supplier.slug'
        db.delete_column(u'frontend_supplier', 'slug')

        # Deleting field 'Company.slug'
        db.delete_column(u'frontend_company', 'slug')

        # Deleting field 'ImportNote.slug'
        db.delete_column(u'frontend_importnote', 'slug')

        # Deleting field 'Medium.slug'
        db.delete_column(u'frontend_medium', 'slug')


    def backwards(self, orm):

        # Changing field 'Product.royalty_img'
        db.alter_column(u'frontend_product', 'royalty_img_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['frontend.RoyaltyImg']))

        # Changing field 'Product.supplier'
        db.alter_column(u'frontend_product', 'supplier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['frontend.Supplier']))

        # Changing field 'Product.medium'
        db.alter_column(u'frontend_product', 'medium_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['frontend.Medium']))

        # Changing field 'Product.size'
        db.alter_column(u'frontend_product', 'size_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['frontend.Size']))

        # User chose to not deal with backwards NULL issues for 'Supplier.slug'
        raise RuntimeError("Cannot reverse this migration. 'Supplier.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Supplier.slug'
        db.add_column(u'frontend_supplier', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Company.slug'
        raise RuntimeError("Cannot reverse this migration. 'Company.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Company.slug'
        db.add_column(u'frontend_company', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ImportNote.slug'
        raise RuntimeError("Cannot reverse this migration. 'ImportNote.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ImportNote.slug'
        db.add_column(u'frontend_importnote', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Medium.slug'
        raise RuntimeError("Cannot reverse this migration. 'Medium.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Medium.slug'
        db.add_column(u'frontend_medium', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'frontend.pricelevelgroup': {
            'Meta': {'ordering': "('name',)", 'object_name': 'PriceLevelGroup'},
        ...
        u'frontend.product': {
            ...
            'royalty': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'royalty_img': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['frontend.RoyaltyImg']"}),
