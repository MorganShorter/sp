...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.from_mail'
        db.add_column(u'frontend_company', 'from_mail',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.from_mail'
        db.delete_column(u'frontend_company', 'from_mail')
    ...
    models = {
        ...
        u'frontend.company': {
            ...
            'abn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            ...
            'from_mail': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legal_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            ...
            'payments': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'pobox': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
